...
#Greetings
echo
echo -e "e[93mJava Libraries compiled by e[32mHax4use[93m, script written by e[32mHax4us e[93mand e[32mMasterDevXe[93m."
echo
...
then
 ...
 arm)
  archname="arm"; tag="v8-151" ;;
 *)
  echo -e "e[91mERROR: Unknown architecture."; echo; exit ;;
 esac

 #Actual installation
 echo -e "e[32m[*] e[34mDownloading JDK-8 (~70Mb) for ${archname}...  🕛This will take some time, so better make a coffee.🕛"
 wget https://github.com/Hax4us/java/releases/download/v8-151/jdk8_arm.tar.gz -q
 ...
 echo
 echo -e "e[32mSCode Compiler was successfully installed!e[39m"
 echo "Enjoy :D"
    touch .scode.runfile
